        ...
        <div id="dynamic-content">
            <div class="table-container" id="table_reservation">
                ...
                <form id="reservation-form">
                    @csrf
                <table class="table table-bordered table-striped" id="reservations_datatable">
                    <thead>
            ...
            <div id="historique-emprunt" style="display: none;">
                ...
                <form id="emprunt-form">
                    @csrf
                    <table class="table table-bordered table-striped" id="historique_emprunts_datatable" style="width: 900px;">
                        <thead>
                            <tr style="background-color: #096097;">
                                <th style="color: white;font-weight:500;">Tier</th>
